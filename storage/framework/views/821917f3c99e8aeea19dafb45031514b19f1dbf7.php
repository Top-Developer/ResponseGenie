...
<head>
    ...
    <link href="<?php echo e(url('/assets/global/plugins/uniform/css/uniform.default.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <?php echo $__env->yieldPushContent(''); ?>
    <link href="<?php echo e(url('/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo e(url('/assets/layouts/layout3/css/themes/default.min.css')); ?>" rel="stylesheet" type="text/css" id="style_color" />
    <link href="<?php echo e(url('/assets/layouts/layout3/css/custom.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo e(url('/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js')); ?>" type="text/javascript"></script>
...
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="<?php echo e(url('/assets/global/plugins/bootstrap-daterangepicker/moment.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(url('/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js')); ?>" type="text/javascript"></script>
