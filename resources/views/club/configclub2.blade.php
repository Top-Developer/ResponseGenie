...
@section('content')
    <div class="main-container">
                        ...
                        <div class="portlet-body tabbable-custom">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="tab_2_1">
                                    @if(isset($club))
                                    <h1 class="space-top page-title text-center">{{$club->club_name}}</h1>
                                    @endif
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="row">
                                            @if(isset($is_admin) && $is_admin == 1)
                                                <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">Edit club contact info</button>
                                            @endif
                                        </div>
                                        <div class="row panel-body">
                                ...
                                <div class="tab-pane fade" id="tab_2_2">
                                    <h1 class="page-title text-center">{{$club->club_name}}</h1>
                                ...
                                <div class="tab-pane fade" id="tab_2_3">
                                    ...
                                    <div class="space-top space-bottom section">
                                        ...
                                        <form class="create-club-form" action="{{url('/club/updateClubInformation')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2" style="text-align: right">Club Slug</label>
                                                <div class="col-md-4">
        ...
        <!-- Modal -->
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="configContactModal" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <form>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-4" style="text-align: right;">Meeting Location</label>
                                            <div class="col-md-8">
                                                <input class="form-control input-inline" name="meeting">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4" style="text-align: right;">Primary Contact</label>
                                            <div class="col-md-8">
                                                <select class="form-control input-inline input-small" name="club_type" >
                                                    <option value="Closed"> Timmer </option>
                                                    <option value="Moderated"> Arnold </option>
                                                    <option value="Open"> Erica </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-4" style="text-align: right;">Secondary Contact</label>
                                            <div class="col-md-8">
                                                <select class="form-control input-inline input-small" name="club_type" >
                                                    <option value="Closed"> Timmer </option>
                                                    <option value="Moderated"> Arnold </option>
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" style="margin: 10px 0 !important;">Save changes</a>
                    </div>
                </div>
            </div>
        </div>
