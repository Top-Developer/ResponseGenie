                            ...
                            <div class="row margin-bottom-20">
                                <div class="col-lg-4 col-md-4">
                                    <div class="portlet light">
                                        ...
                                        <div class="card-desc">
                            <span> {{ \Illuminate\Support\Str::limit("Rosterfi makes it easy to keep your membership roster up to date and accurate.
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="portlet light">
                                        ...
                                        <div class="card-desc">
                            <span> {{ \Illuminate\Support\Str::limit("Accept online payments through your Stripe or Paypal account.
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="portlet light">
                                        ...
                                        <div class="card-desc">
                            <span> {{ \Illuminate\Support\Str::limit("Make it eaiser for prospective members to find your club and see what you are up to.
